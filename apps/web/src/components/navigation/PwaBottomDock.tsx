...
export function PwaBottomDock() {
  ...
  const navItems = [
    ...
    { href: "/outlets", label: "Cabang", icon: MapPin },
      ...
      <AnimatePresence>
        {!isOnline && (
          ...
          >
            ...
            <span>Koneksi offline terdeteksi — beberapa fitur memerlukan internet.</span>
          </motion.div>
        )}
      </AnimatePresence>
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                key={item.href}
                href={item.href}
                className={`relative flex flex-col items-center justify-center w-12 h-11 sm:w-14 sm:h-12 rounded-full transition-all duration-300 ${
                  isActive
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-text-muted">Layar Pesanan Dapur</div>
                      </div>
                    </Link>
                  </motion.div>
                )}
