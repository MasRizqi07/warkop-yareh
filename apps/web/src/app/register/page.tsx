        ...
        >
          {success ? (
            ...
            <form className="space-y-6" onSubmit={handleRegister}>
                ...
                <div className="mt-2 relative">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      setPhone(nextPhone);
                      if (!nextPhone.trim()) setWhatsAppMarketingOptIn(false);
                    }}
                    className="pl-10"
              ...
              <label className="flex items-start gap-3 rounded-xl border border-slate-200 p-4 text-sm text-slate-700 dark:border-slate-800 dark:text-slate-300">
                <input
                  type="checkbox"
                  className="mt-1"
                  ...
                  disabled={!phone.trim()}
                  onChange={(event) =>
                    setWhatsAppMarketingOptIn(event.target.checked)
                  }
                />
                <span>
                  Saya setuju menerima pesan promosi Warkop Ya&apos;reh melalui
                  WhatsApp. Pilihan ini opsional dan dapat dicabut dari profil.
                </span>
              </label>
