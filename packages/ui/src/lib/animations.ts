...
export const fadeInUp: Variants = {
  ...
  visible: {
    opacity: 1,
    y: 0,
    transition: { duration: DURATION.smooth, ease: EASE.enter },
  },
  exit: {
    opacity: 0,
    y: 16,
...
export const clipReveal: Variants = {
  ...
  visible: {
    ...
    transition: { duration: DURATION.verySlow, ease: EASE.enter },
  },
};
...
export const wordReveal: Variants = {
  ...
  visible: {
    opacity: 1,
    y: '0%',
    transition: { duration: DURATION.smooth, ease: EASE.fluid },
  },
};
...
export const staggerItemScale: Variants = {
  ...
  visible: {
    ...
    y: 0,
    scale: 1,
    transition: { ...smoothEase, duration: 0.5 },
  },
};
...
export const hoverLift = {
  whileHover: {
    y: -6,
    boxShadow: '0 20px 60px rgba(0,0,0,0.12), 0 8px 24px rgba(196,98,45,0.08)',
